...
dotnet user-secrets set "ConnectionStrings:DefaultConnection" "Host=ep-royal-dawn-b2k5kx9x.c-6.eu-central-1.aws.neon.tech;Database=neondb;Username=neondb_owner;Password=<the password for your neon postgerSQL DB, you have kept it on your computer and can also rotate it from neon web console where you have logged using your google account>;SSL Mode=Require"