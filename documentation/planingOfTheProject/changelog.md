...
* Require all search terms to match Title or Ingredients
* Trim leading and trailing whitespace from search terms
* Preserve search terms when navigating between pages
